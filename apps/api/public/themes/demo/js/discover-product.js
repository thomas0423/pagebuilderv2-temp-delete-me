function setDiscoverProductCarousel(parentClassID) {
    let itemClassName = "col-11 col-lg-3 col-md-6 mx-auto mx-md-0";
    let items = parentClassID.getElementsByClassName(itemClassName);
    ...
    function initCarousel() {
        ...
        if(totalItems <= numberProductsToDisplay) {
            $('.carousel-button-next', parentClassID).hide();
            $('.carousel-button-prev', parentClassID).hide();
        }else{
            
            if(carouselMode == 0){
                $('.carousel-button-prev', parentClassID).hide();
                $('.carousel-button-next', parentClassID).show();
            }else if(carouselMode == 1){
                $('.carousel-button-prev', parentClassID).show();
                $('.carousel-button-next', parentClassID).show();
            }
        }
    ...
    function setEventListeners() {
        var next = parentClassID.getElementsByClassName('carousel-button-next')[0],
            prev = parentClassID.getElementsByClassName('carousel-button-prev')[0];
