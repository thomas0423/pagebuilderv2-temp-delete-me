...
if (document.querySelector('.block-affin-life-carousel-horizontal')) {
    showSlides(1);
}
function propertyUnderAuctionAccordion() {
    const acc = document.querySelectorAll(`.property-under-auction-collapsible`);
    let i;
...
if (document.querySelector('.block-property-under-auction')) {
    propertyUnderAuctionAccordion();
}
...
function carouselInfoCardAnnouncement(d) {
...
function carouselInfoCardNews(d) {
    var itemClassName = "p-0 col-12 margin-bottom carousel__photo";
    let items = d.getElementsByClassName(itemClassName);
    let totalItems = items.length;
    console.log(totalItems + " total items");
