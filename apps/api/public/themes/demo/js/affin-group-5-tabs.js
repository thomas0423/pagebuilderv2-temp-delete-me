function switchAffinGroup5Tab(tabName, event) {
    ...
    const tabPanelSelector = `.${parentClassName} .content-container > .tab`;

    const tabs = document.querySelectorAll(tabPanelSelector);
    ...
    const tab = document.querySelector(`${tabPanelSelector}.${tabName}`);
...
function switchTab5FirstTab() {
    ...
    const allTabs = document.querySelectorAll(".block-affin-group-5-tabs .content-container > .tab");
