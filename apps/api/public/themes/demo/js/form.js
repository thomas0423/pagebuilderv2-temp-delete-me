function formAccordion(id, parentClassName) {
    const firstCategory = document.querySelector('.' + parentClassName + ' #' + id);
    if (firstCategory) {
        firstCategory.classList.add('active');
    }

    const coll = document.querySelectorAll('.' + parentClassName + ' .form-collapsible');
    let i, j;
    ...
    const header_btn = document.querySelectorAll('.' + parentClassName + ' .form-header-btn');
    const accordion_group = document.querySelectorAll('.' + parentClassName + ' .form-accordion-group');
